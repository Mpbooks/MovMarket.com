...
if (isset($_GET['q'])) {
    // Sanitize e obter a consulta de pesquisa
    ...
    // Consulta SQL para recuperar os produtos relacionados à pesquisa
    $consulta_sql = "SELECT * FROM produtos WHERE nome LIKE ? ORDER BY data DESC";

    // Prepara a consulta
    $stmt = $conn->prepare($consulta_sql);

    // Adiciona o caractere de curinga (%) ao termo de pesquisa
    ...
    if ($result->num_rows > 0) {
        while ($produto = $result->fetch_assoc()) {
            ...
            echo '<form action="filtros/criar.php" method="post">';
            // Estrutura HTML do produto
            echo '<div class="products main ">';
            echo '<div class="item">';
            echo '<div class="media">';
            echo '<div class="thumbnail object-covers">';
            echo '<a href="' . $produto['link'] . '">';
            echo '<img class="imagem" src="' . HOME . '/uploads/' . $produto['capa'] . '" alt="' . $produto['nome'] . '">';
            echo '</a>';
            echo '</div>';
            ...
            echo '<h3 class="main-links"><a href="' . $produto['link'] . '">' . $produto['nome'] . '</a></h3>';
           
            echo '<div class="price">';
            echo '<span class="current">R$ ' . $produto['valor'] . '</span>';
    ...
    // Se não houver consulta de pesquisa, redirecione o usuário de volta à página inicial ou exiba uma mensagem informando que nenhuma pesquisa foi especificada
    header("Location: loja.php"); // Redireciona para a página inicial
...
?>
    ...
    <script>
        document.getElementById("searchInput").addEventListener("keypress", function(event) {
            // Se a tecla pressionada for "Enter", envie o formulário
            if (event.key === "Enter") {
...
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    <script src="../loja/script.js"></script>
</body>
</html>
